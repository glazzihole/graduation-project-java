 ...
 *******************************************************************************/
package nl.inl.blacklab.core.index;
...
import nl.inl.blacklab.core.index.HookableSaxHandler.ContentCapturingHandler;
import nl.inl.blacklab.core.index.HookableSaxHandler.ElementHandler;
import nl.inl.blacklab.core.index.complex.ComplexField;
import nl.inl.blacklab.core.index.complex.ComplexFieldProperty;
import nl.inl.blacklab.core.index.complex.ComplexFieldProperty.SensitivitySetting;
import nl.inl.blacklab.core.index.complex.ComplexFieldUtil;
import nl.inl.blacklab.core.search.Searcher;
import nl.inl.blacklab.core.search.indexstructure.FieldType;
...
import nl.inl.blacklab.core.search.indexstructure.MetadataFieldDesc.UnknownCondition;
...
public abstract class DocIndexerXmlHandlers extends DocIndexerAbstract {
	...
	public void startElement(String uri, String localName, String qName,
		...
		if (!outputPrefixMapping.isEmpty()) {
			for (Entry<String, String> e : outputPrefixMapping.entrySet()) {
