...
import nl.inl.blacklab.core.indexers.DocIndexerAlto;
import nl.inl.blacklab.core.indexers.DocIndexerFolia;
import nl.inl.blacklab.core.indexers.DocIndexerPageXml;
import nl.inl.blacklab.core.indexers.DocIndexerTei;
import nl.inl.blacklab.core.indexers.DocIndexerTeiPosInFunctionAttr;
import nl.inl.blacklab.core.indexers.DocIndexerTeiText;
import nl.inl.blacklab.core.indexers.DocIndexerWhiteLab2;
import nl.inl.blacklab.core.indexers.DocIndexerXmlSketch;
		...
		if (docIndexerClass == null) {
			...
			try {
				...
				try {
					...
					docIndexerClass = Class.forName("nl.inl.blacklab.core.indexers." + formatIdentifier);
				} catch (Exception e) {
