...
import nl.inl.blacklab.core.search.TextPatternAnd;
import nl.inl.blacklab.core.search.TextPatternAnyToken;
import nl.inl.blacklab.core.search.TextPatternCaptureGroup;
import nl.inl.blacklab.core.search.TextPatternConstrained;
import nl.inl.blacklab.core.search.TextPatternEdge;
import nl.inl.blacklab.core.search.TextPatternNot;
import nl.inl.blacklab.core.search.TextPatternOr;
import nl.inl.blacklab.core.search.TextPatternPositionFilter;
import nl.inl.blacklab.core.search.TextPatternProperty;
import nl.inl.blacklab.core.search.TextPatternRegex;
import nl.inl.blacklab.core.search.TextPatternRepetition;
import nl.inl.blacklab.core.search.TextPatternSequence;
import nl.inl.blacklab.core.search.TextPatternTags;
...
import nl.inl.blacklab.core.search.matchfilter.MatchFilterAnd;
import nl.inl.blacklab.core.search.matchfilter.MatchFilterEquals;
import nl.inl.blacklab.core.search.matchfilter.MatchFilterImplication;
import nl.inl.blacklab.core.search.matchfilter.MatchFilterNot;
import nl.inl.blacklab.core.search.matchfilter.MatchFilterOr;
import nl.inl.blacklab.core.search.matchfilter.MatchFilterString;
import nl.inl.blacklab.core.search.matchfilter.MatchFilterTokenProperty;
...
/* a repetition specifier */
 ...
 Integer[] minMax = new Integer[2];
    ...
    case 24:{
      jj_consume_token(24);
minMax[0] = 0; minMax[1] = BLSpanQuery.MAX_UNLIMITED; {if ("" != null) {
            return minMax;
        }
        }
      break;
    ...
    case 25:{
      jj_consume_token(25);
minMax[0] = 1; minMax[1] = BLSpanQuery.MAX_UNLIMITED; {if ("" != null) {
            return minMax;
        }
        }
      break;
...
minMax[0] = 0; minMax[1] = 1; {if ("" != null) {
    ...
    default:
      ...
      if (jj_2_2(3)) {
        ...
        jj_consume_token(28);
minMax[0] = minMax[1] = num(t); {if ("" != null) {
              return minMax;
          }
          }
      } else {
