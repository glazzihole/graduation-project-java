...
import nl.inl.blacklab.core.search.Concordance;
import nl.inl.blacklab.core.search.ConcordanceType;
import nl.inl.blacklab.core.search.Hit;
import nl.inl.blacklab.core.search.Hits;
import nl.inl.blacklab.core.search.HitsWindow;
...
import nl.inl.blacklab.core.search.grouping.GroupPropertyIdentity;
...
import nl.inl.blacklab.core.search.grouping.HitPropertyDocumentId;
import nl.inl.blacklab.core.search.grouping.HitPropertyDocumentStoredField;
import nl.inl.blacklab.core.search.grouping.HitPropertyHitText;
import nl.inl.blacklab.core.search.grouping.HitPropertyLeftContext;
import nl.inl.blacklab.core.search.grouping.HitPropertyMultiple;
import nl.inl.blacklab.core.search.grouping.HitPropertyRightContext;
import nl.inl.blacklab.core.search.grouping.HitPropertyWordLeft;
import nl.inl.blacklab.core.search.grouping.HitPropertyWordRight;
...
//import nl.inl.blacklab.core.util.LogUtil;
import nl.inl.blacklab.core.util.LuceneUtil;
import nl.inl.blacklab.core.util.StringUtil;
import nl.inl.blacklab.core.util.TimeUtil;
import nl.inl.blacklab.core.util.Timer;
import nl.inl.blacklab.core.util.XmlUtil;
...
public class QueryTool {
	...
	class ParserCorpusQl extends Parser {
		...
		public TextPattern parse(String query) throws ParseException {
			...
			} catch (nl.inl.blacklab.core.queryParser.corpusql.ParseException e) {
				throw new ParseException(e.getMessage());
			} catch (nl.inl.blacklab.core.queryParser.corpusql.TokenMgrError e) {
				throw new ParseException(e.getMessage());
			} catch (Exception e) {
