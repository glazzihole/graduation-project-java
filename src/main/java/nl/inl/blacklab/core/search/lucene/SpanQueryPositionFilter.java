...
public class SpanQueryPositionFilter extends BLSpanQueryAbstract {
	 ...
	 */
	public SpanQueryPositionFilter(BLSpanQuery producer, BLSpanQuery filter, Operation op, boolean invert) {
	 ...
	 */
	public SpanQueryPositionFilter(BLSpanQuery producer, BLSpanQuery filter, Operation op, boolean invert, int leftAdjust, int rightAdjust) {
	...
	public BLSpanQuery rewrite(IndexReader reader) throws IOException {
		...
		if (!invert && op != Operation.STARTS_AT && op != Operation.ENDS_AT && producer instanceof SpanQueryAnyToken) {
